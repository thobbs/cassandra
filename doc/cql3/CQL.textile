...
There is a performance penalty for batch atomicity. If you do not want to incur this penalty, you can tell Cassandra to skip the batchlog the @UNLOGGED@ option. If the @UNLOGGED@ option is used, operations are only atomic within a single partition.

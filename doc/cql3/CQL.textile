...
* There is no guaranteed order for the application of operations (even for the same partition key). To achieve a particular operation ordering, you must use per-operation timestamps.

...
public class DynamicEndpointSnitch extends AbstractEndpointSnitch implements ILatencySubscriber, DynamicEndpointSnitchMBean
{
    ...
    private void updateScores() // this is expensive
    {
        ...
        double maxLatency = 1;
        // We're going to weight the latency and time since last reply for each host against the worst one we see, to
        // arrive at sort of a 'badness percentage' for both of them. First, find the worst for each:
